...
const AddShows = () => {
  ...
  const handleRemoveTime = (date,time) =>{
    setDateTimeSelection((prev)=>{
      const filltered = prev[date].filter((t)=> t!== time);
    ...
    <div>
      ...
      <div className='mt-6'>
          ...
          <div className='inline-flex gap-5 border border-gray-600 p-1 pl-3 rounded-lg'>
            <input type="datetime-local" value={dateTimeInput} onChange={(e)=> setDataTimeInput(e.target.value)} className='outline-none rounded-md'/>
